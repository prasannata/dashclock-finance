 ...
 *     new SwipeDismissListViewTouchListener(listView, new SwipeDismissListViewTouchListener.OnDismissCallback() {
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
  ...
  public interface DismissCallbacks {
     ...
     *          An array of positions to dismiss, sorted in descending order for
     *          convenience.
     */
   ...
   * @param callbacks
   *          The callback to trigger when the user has indicated that she would
  ...
  /**
   * Returns an {@link android.widget.AbsListView.OnScrollListener} to be added
   * to the {@link ListView} using
   * {@link ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}

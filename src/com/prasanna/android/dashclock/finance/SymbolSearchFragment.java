...
public class SymbolSearchFragment extends ListFragment {
        ...
        public void onClick(View v) {
          if (!savedSymbolSet.contains(company.symbol)) {
            if (AppUtil.canAddTicker(appContext)) {
              ...
              Toast.makeText(getActivity(), "You can have only a maximum of 5 symbols", Toast.LENGTH_LONG).show();
          }
        }
      });
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    searchResultAdapter =
        new SearchResultAdapter(appContext, R.layout.company_search_result_item, R.id.companyName, companySearchResults);

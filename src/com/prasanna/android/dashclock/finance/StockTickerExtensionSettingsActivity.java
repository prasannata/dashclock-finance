...
public class StockTickerExtensionSettingsActivity extends FragmentActivity implements OnTickerAddListener,
    OnTickerRemoveListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    symbolListFragment = (SymbolListFragment) getSupportFragmentManager().findFragmentById(R.id.symbol_list_fragment);
    symbolSearchFragment =
        (SymbolSearchFragment) getSupportFragmentManager().findFragmentById(R.id.symbol_search_fragment);
